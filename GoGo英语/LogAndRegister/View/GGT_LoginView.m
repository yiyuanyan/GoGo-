...
- (void)setUpContentView {
    ...
    [self.forgetPasswordButton setTitleColor:UICOLOR_FROM_HEX(0x696969) forState:(UIControlStateNormal)];
    ...
    [self.loginButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self.mas_centerX);
        make.top.equalTo(self.forgetPasswordButton.mas_bottom).with.offset(LineY(20));
